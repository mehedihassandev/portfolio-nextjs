      ...
      <div>
        <div className="flex flex-col lg:flex-row gap-5 items-center">
          ...
          <p className="text-base leading-[32px] text-[#323232] w-full md:w-4/5">
            MyCare’s visual output combined aesthetics and usability. A
            user-friendly interface, fresh color scheme, custom illustrations,
            and consistency resulted in an engaging shopping experience.
          </p>
        </div>
      </div>
