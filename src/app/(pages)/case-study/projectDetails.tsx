            ...
            <div className="flex flex-col gap-1" key={index}>
              ...
              {Array.isArray(detail.content) ? (
                detail.content.map((item, idx) => (
                  <p className="text-base text-white" key={idx}>
                    {item}
                  </p>
                ))
              ) : (
        ...
        <div className="pt-10">
          <div className="flex flex-col lg:flex-row gap-5">
            ...
            <p className="text-base leading-[32px] text-white w-full md:w-4/5">
              MyCare is a fintech app that allows users to manage their money
              and make payments. It is designed to help users keep track of
              their finances and make informed decisions about their spending.
              The app is designed to be user-friendly and intuitive, with a
