      ...
      <div className="px-5 lg:px-24 mx-auto max-w-screen-2xl">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
          <div className="flex flex-col overflow-hidden mb-2">
            <h2 className="text-lg md:text-2xl text-gray">Project</h2>
            <p className="text-base md:text-xl pt-2 md:pt-4">App Design</p>
          </div>
      ...
      <div className="px-5 lg:px-24 mx-auto max-w-screen-2xl md:pb-10">
        <div className="flex flex-col lg:flex-row gap-5 items-center">
          ...
          <p className="text-base leading-[32px] text-[#323232] w-full md:w-4/5">
            <span className="text-primary">MyCare App</span> offers a seamless
            and efficient platform for managing everyday financial transactions.
            By integrating features such as Top-up, Paybill, and Shop, it
            provides users with a versatile and convenient tool for handling
            various payment needs. The app’s user-friendly interface ensures
            that even those with minimal technical knowledge can navigate and
            utilize its services effectively. As digital transactions become
            increasingly prevalent, the Online Wallet App stands out as a
            reliable and secure solution for modern financial management.
          </p>
        </div>
      </div>
    </section>
