...
export default function About() {
  return (
    <>
      ...
      />
      <div className="px-5 lg:px-24 mx-auto max-w-screen-2xl m-auto" id="about">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mb-14 md:mb-5">
          ...
          <div className="col-span-1 lg:col-span-2 lg:row-span-10 pt-14">
            ...
            <p className="text-[16px] text-[#323433] leading-[24px] font-semibold pt-2 pb-5">
              Self-motivated Product(UX/UI) Designer with 4+ years of experience
              in creating digital products across diverse sectors, including POS
              systems, SaaS, enterprise software, mobile apps, fintech, and
              crypto websites.
            </p>
            <p className="text-[16px] text-[#323433] leading-[24px] pt-2 ">
              In my role, I have enough knowledge of user experience methods,
              visual design, innovation, ideation, prototyping, concept
              visualization, user testing, presentation, and support the
              developers through the launch process. Values teamwork and brings
              a growth mindset to every challenge, constantly seeking new
