        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-24">
          <div>
            ...
            <p className="text-[16px] leading-[24px] pt-5">
              An Enthusiastic Product (UX/UI) Designer dedicated to creating
              user-focused digital experiences. Elevate your business with
              custom design solutions that drive engagement and growth.
            </p>
            <div className="flex items-center gap-14">
              <a
                href="https://drive.google.com/uc?export=download&id=1EC7NnIgRbqYN1uy0QHqQFF6BLSwTUtCp"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#0DB760] text-white text-[16px] font-medium leading-[24px] px-[3rem] py-3 rounded-lg mt-10"
              >
                Download CV
              </a>
